...
public class ProjectConfig {
    ...
    * */
    ...
    /*
        ...
        Vehicle, by passing the vehicle as a method parameter to the person() bean method.

        Spring injects the vehicle bean to a person bean using Dependency Injection. Spring will
